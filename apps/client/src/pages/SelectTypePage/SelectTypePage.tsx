  ...
  return (
    <section className="grow pb-32 animate-reveal-up">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto perspective-1000">
          {options.map((opt, index) => {
            ...
            return (
              <button
                ...
                className={`group relative flex flex-col items-center justify-center aspect-4/5 overflow-hidden rounded-[2.5rem] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_-15px_rgba(28,25,23,0.2)] text-left animate-reveal-up opacity-0 [animation-fill-mode:forwards]
                  ${
                    opt.dark
